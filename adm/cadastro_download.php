<?php	
	...
	$row=null;
	$result=null;
	$sql	= "SELECT codigo,nome,conteudo,data_inicio,data_fim FROM paginas  where (empresa=".$_SESSION["empresa"].") and(nome='donwload') and (data_fim is null) order by data_inicio desc";
	...
	if ($_POST['acao']=='atualizar pagina'){
		...
		$sql = "insert into paginas (nome,conteudo,data_inicio) values ('donwload','".$conteudo."','".$data_hora."');";
